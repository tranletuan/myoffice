...
public class ImplementController extends AbstractController {
	...
	public Integer autoGeneratedNumber(
		...
		logger.info("OKE");
		return dataService.findMaxNumber(tenureId, docTypeId, organId);
	}
	...
	public ModelAndView submitNewDoc(
		...
		if (num > 0) {
			...
			doc.setNumber(dataService.findMaxNumber(tenureId, docTypeId, organ.getOrganId()) - 1);
		}
	...
	public ModelAndView claimTask(@RequestParam("docId") Integer docId){
